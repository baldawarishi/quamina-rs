...
|-----------|---------|-----------|--------|
| status_context_fields | 404 | 566 | Go 1.40x |
...
| # | Task | Impact |
|---|------|--------|
| 10 | Switch to `parking_lot::Mutex` | ~10-20ns |
| 11 | Combine flattener + nfa_bufs into single `MatchState` Mutex | ~20-30ns |
| 12 | Reuse `ref_fields` Vec in `MatchState` | ~10-20ns |
